    ...
    return (
        <div className="w-full flex flex-col p-4 h-full md:w-1/2 md:self-center lg:w-1/3">
            ...
            <FormGroup className="form-control">
                ...
                <Input type="email" required className="form-input" name="email" id="LOGIN_EMAIL" placeholder="Email" value={email}
                       onChange={handleEmailChange}
                />
            </FormGroup>
            <FormGroup className="form-control">
                <Label for="LOGIN_PASSWORD" className="text-black">Password</Label>
                <Input type="password" required className="form-input" name="password" id="LOGIN_PASSWORD" placeholder="Password" value={password}
